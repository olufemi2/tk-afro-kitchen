...
export function Footer() {
  return (
    <footer className="bg-gradient-to-b from-white to-orange-50 border-t">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="font-bold text-lg mb-4">TK Afro Kitchen</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/menu" className="text-sm text-muted-foreground hover:text-orange-600 transition-colors">
                  Menu
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <a href="mailto:info@tkafrokitchen.com" className="hover:text-orange-600 transition-colors">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 rounded-full bg-gradient-to-r from-orange-600 to-yellow-500 flex items-center justify-center text-white hover:from-orange-700 hover:to-yellow-600 transition-colors"
              >
